document.addEventListener("DOMContentLoaded", function () {
    ...
    if (urlPath !== "/Runtime/Runtime/Form.aspx") {
        ...
        let logoSrc;
        if (urlPath.includes("/Public/Runtime/") || urlPath.includes("/PublicAR/Runtime/")) {
            logoSrc = "https://ns.namaservices.om/Style/logo.png";
        } else {
            logoSrc = "https://ns.namaservices.om/Style/logo Nama supply .png";
            // logoSrc = "https://ns.namaservices.om/Style/logo.png";
        }

        const logoImage = $(`<img src="${logoSrc}" alt="Company Logo" class="sidebar-logo">`);
